        ...
        {view === 'login' && (
          <div className="animate-in fade-in zoom-in-95 duration-300">
            ...
            <button 
              ...
              disabled={isLoading}
              type="button"
              className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-bold py-3.5 rounded-xl hover:bg-gray-100 transition duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] mb-6 disabled:opacity-70 disabled:cursor-not-allowed"
            >
            ...
            <div className="relative flex items-center justify-center mb-6">
              ...
              <div className="relative px-4 bg-transparent text-sm text-white/50 backdrop-blur-xl">Or continue with email</div>
            </div>
