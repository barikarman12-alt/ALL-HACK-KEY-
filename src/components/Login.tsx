          ...
          <div className="animate-in fade-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className="w-full bg-white text-indigo-900 font-bold py-3.5 rounded-xl hover:bg-gray-100 transition duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
          ...
          <div className="animate-in fade-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className="w-full bg-white text-indigo-900 font-bold py-3.5 rounded-xl hover:bg-gray-100 transition duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] mt-4 disabled:opacity-70 disabled:cursor-not-allowed"
              >
